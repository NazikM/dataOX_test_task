...
class MainSpider(CrawlSpider):
    ...
    def start_requests(self):
        ...
        yield scrapy.Request(url='https://www.kijiji.ca/b-apartments-condos/fredericton/c37l1700018', headers={
            'User-Agent': self.user_agent
        })
        for i in range(2, 6):
            yield scrapy.Request(
                url=f"https://www.kijiji.ca/b-apartments-condos/fredericton/page-{i}/c37l1700018",
                headers={
                    'User-Agent': self.user_agent
                }, dont_filter=True)
        yield scrapy.Request(url='https://www.kijiji.ca/b-apartments-condos/city-of-halifax/c37l1700321', headers={
            'User-Agent': self.user_agent
        })
        for i in range(2, 13):
            yield scrapy.Request(
                url=f"https://www.kijiji.ca/b-apartments-condos/city-of-halifax/page-{i}/c37l1700321",
                headers={
                    'User-Agent': self.user_agent
                }, dont_filter=True)
        yield scrapy.Request(url='https://www.kijiji.ca/b-apartments-condos/st-johns/c37l1700113', headers={
            'User-Agent': self.user_agent
        })
        for i in range(2, 7):
            yield scrapy.Request(
                url=f"https://www.kijiji.ca/b-apartments-condos/st-johns/page-{i}/c37l1700113",
                headers={
                    'User-Agent': self.user_agent
                }, dont_filter=True)
        yield scrapy.Request(url='https://www.kijiji.ca/b-apartments-condos/edmonton/c37l1700203', headers={
            'User-Agent': self.user_agent
        })
        yield scrapy.Request(url='https://www.kijiji.ca/b-appartement-condo/ville-de-quebec/c37l1700124', headers={
            'User-Agent': self.user_agent
        })
        for i in range(2, 26):
            yield scrapy.Request(
                url=f"https://www.kijiji.ca/b-appartement-condo/ville-de-quebec/page-{i}/c37l1700124",
                headers={
                    'User-Agent': self.user_agent
                }, dont_filter=True)
        for i in range(2, 82):
            yield scrapy.Request(
                url=f"https://www.kijiji.ca/b-apartments-condos/edmonton/page-{i}/c37l1700203",
                headers={
                    'User-Agent': self.user_agent
                }, dont_filter=True)
        yield scrapy.Request(url='https://www.kijiji.ca/b-apartments-condos/city-of-toronto/c37l1700273', headers={
            'User-Agent': self.user_agent
        })
        for i in range(2, 3):
            yield scrapy.Request(
        ...
        yield scrapy.Request(url='https://www.kijiji.ca/b-apartments-condos/regina/c37l1700196', headers={
            'User-Agent': self.user_agent
        })
        for i in range(2, 16):
            yield scrapy.Request(
                url=f"https://www.kijiji.ca/b-apartments-condos/regina/page-{i}/c37l1700196",
                headers={
                    'User-Agent': self.user_agent
                }, dont_filter=True)
        yield scrapy.Request(url='https://www.kijiji.ca/b-apartments-condos/victoria-bc/c37l1700173', headers={
            'User-Agent': self.user_agent
        })
        for i in range(2, 9):
            yield scrapy.Request(
                url=f"https://www.kijiji.ca/b-apartments-condos/victoria-bc/page-{i}/c37l1700173",
                headers={
                    'User-Agent': self.user_agent
                }, dont_filter=True)
        yield scrapy.Request(url='https://www.kijiji.ca/b-apartments-condos/winnipeg/c37l1700192', headers={
            'User-Agent': self.user_agent
        })
        for i in range(2, 45):
            yield scrapy.Request(
                url=f"https://www.kijiji.ca/b-apartments-condos/winnipeg/page-{i}/c37l1700192",
                headers={
                    'User-Agent': self.user_agent
                }, dont_filter=True)
